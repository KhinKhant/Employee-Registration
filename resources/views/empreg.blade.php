    ...
    <div class="container">
        <div class="col-sm-6">
            <form method="post" action="{{route('reg.store')}}">
                @csrf
                 <h2 class="text-success">Brycen Myanmar Company Limited</h2>
                 
                 <p class="small">Welcome From Brycen Myanmar Company.<br> BRYCEN: a company that continues to evolve We provide optimal solutions with our world-Class technology and rich experience We tackle new challenges every day following our motto: Sail together to the Smart Galaxy<br><br>
                </p>
           <h4 class="text-success">Employee Registration Form<br></h4>
